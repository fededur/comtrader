#' Get SUV function for UN Comtrade Database API
#'
#' @description Get SUV function for UN Comtrade Database API
...
#' @param qtyUnitCode Quantity Unit Code
#'
#' @return a tibble
#'
#' @export
...
getSUV <- function(
  ...
  res <- httr::GET(
    url = paste0("https://comtradeapi.un.org/data/v1/getSUV/",domain_string,"?",query_string),
